...
namespace Application.Configuration
{
    ...
    public static class DapperDatabaseConfiguration
    {
        ...
        {
            services.AddDapper(options => options.ConnectionString = configuration["ConnectionStrings:BdMensagem_uMensagem_Config"]);

            services.AddTransient<IDbConnection>((sp) => new SqlConnection(configuration["ConnectionStrings:BdMensagem_uMensagem_Config"]));
